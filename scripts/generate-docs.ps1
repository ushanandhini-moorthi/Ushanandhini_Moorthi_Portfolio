...
# Generate PDF
pandoc "facebook-qsg\source\markdown\quick_Start.md" -o "facebook-qsg\output\pdf\quick_Start.pdf" --from=gfm+hard_line_breaks --pdf-engine=xelatex --resource-path="facebook-qsg/source/markdown;facebook-qsg/assets" -V geometry:margin=1in -V mainfont="Times New Roman"
